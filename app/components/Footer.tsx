...
export default function Footer() {
    return (
        <footer className="bg-gray-900 bottom-0 fixed w-full">
            <div className="container px-6 py-8 mx-auto">
                ...
                <div className="flex flex-col items-center sm:flex-row sm:justify-between">
                    <p className="text-sm text-gray-500">© Jakub Gawron CKS Slavia Copyright 2024. Wszelkie prawa zastrzeżone.</p>
